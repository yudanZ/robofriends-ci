(function (global, factory) {
	...
	module.exports = [{ name: 'query', matcher: getQueryStringMatcher }, { name: 'method', matcher: getMethodMatcher }, { name: 'headers', matcher: getHeaderMatcher }, { name: 'params', matcher: getParamsMatcher }, { name: 'body', matcher: getBodyMatcher, usesBody: true }, { name: 'functionMatcher', matcher: getFunctionMatcher }, { name: 'url', matcher: getUrlMatcher }];
	});

	unwrapExports(matchers);

	var Route_1 = createCommonjsModule(function (module) {
	...
	var filterCallsWithMatcher = function filterCallsWithMatcher(matcher) {
		...
		var _ref = new Route_1([(0, _assign2.default)({ matcher: matcher, response: 'ok' }, options)], this);
